 ...
 */var hg;function dS(){if(hg)return Lo;hg=1;var s=Symbol.for("react.transitional.element"),t=Symbol.for("react.fragment");function i(r,l,c){var h=null;if(c!==void 0&&(h=""+c),l.key!==void 0&&(h=""+l.key),"key"in l){c={};for(var d in l)d!=="key"&&(c[d]=l[d])}else c=l;return l=c.ref,{$$typeof:s,type:r,key:h,ref:l!==void 0?l:null,props:c}}return Lo.Fragment=t,Lo.jsx=i,Lo.jsxs=i,Lo}var dg;function pS(){return dg||(dg=1,Qf.exports=dS()),Qf.exports}var wt=pS(),Jf={exports:{}},le={};/**
 * @license React
 * react.production.js
 *
 * Copyright (c) Meta Platforms, Inc. and affiliates.
...
#define LOW_PRECISION`),t}function WT(s){let t="SHADOWMAP_TYPE_BASIC";return s.shadowMapType===L_?t="SHADOWMAP_TYPE_PCF":s.shadowMapType===JS?t="SHADOWMAP_TYPE_PCF_SOFT":s.shadowMapType===sa&&(t="SHADOWMAP_TYPE_VSM"),t}function qT(s){let t="ENVMAP_TYPE_CUBE";if(s.envMap)switch(s.envMapMode){case Ls:case Ns:t="ENVMAP_TYPE_CUBE";break;case Wc:t="ENVMAP_TYPE_CUBE_UV";break}return t}function YT(s){let t="ENVMAP_MODE_REFLECTION";if(s.envMap)switch(s.envMapMode){case Ns:t="ENVMAP_MODE_REFRACTION";break}return t}function jT(s){let t="ENVMAP_BLENDING_NONE";if(s.envMap)switch(s.combine){case N_:t="ENVMAP_BLENDING_MULTIPLY";break;case _y:t="ENVMAP_BLENDING_MIX";break;case vy:t="ENVMAP_BLENDING_ADD";break}return t}function ZT(s){const t=s.envMapCubeUVHeight;if(t===null)return null;const i=Math.log2(t)-2,r=1/t;return{texelWidth:1/(3*Math.max(Math.pow(2,i),112)),texelHeight:r,maxMip:i}}function KT(s,t,i,r){const l=s.getContext(),c=i.defines;let h=i.vertexShader,d=i.fragmentShader;const m=WT(i),p=qT(i),g=YT(i),_=jT(i),x=ZT(i),M=BT(i),b=IT(c),R=l.createProgram();let y,v,O=i.glslVersion?"#version "+i.glslVersion+`
